...
#ifndef VENDOR_EDIT
#Ling.Guo@PSW.MM.Display.LCD.Machine, 2018/10/17,modify for logo
#BOOT_LOGO = hdplus
#else
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw hi1336_mipi_raw hi1336_lianyi_mipi_raw gc8034_mipi_raw hi846_dongci_mipi_raw hi846_mipi_raw sp2509v_mipi_raw gc2375h_mipi_raw gc2375h_chengxiangtong_mipi_raw s5k3p9sp_mipi_raw
CUSTOM_2G_HAL_IMGSENSOR = 2g_s5k3l6_mipi_raw 2g_hi1336_mipi_raw 2g_hi1336_lianyi_mipi_raw 2g_gc8034_mipi_raw 2g_hi846_dongci_mipi_raw 2g_hi846_mipi_raw
CUSTOM_HAL_LENS = dw9772af dw9714af cn3937af
CUSTOM_HAL_MAIN2_IMGSENSOR = gc2375h_mipi_raw gc2375h_chengxiangtong_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw hi1336_mipi_raw hi1336_lianyi_mipi_raw
CUSTOM_HAL_MAIN_LENS =
# ifdef ODM_WT_EDIT
# Jianfeng.Liang@ODM_WT.BSP.Sensors.Config, 2018/09/29, Add for bringup sensors
CUSTOM_HAL_MSENSORLIB = akl vtclib
# endif
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS =
CUSTOM_HAL_SUB_IMGSENSOR = gc8034_mipi_raw hi846_dongci_mipi_raw hi846_mipi_raw s5k3p9sp_mipi_raw
CUSTOM_HAL_SUB_LENS =
...
# Jianfeng.Liang@ODM_WT.BSP.Sensors.Config, 2018/12/20, Modify for remove barometer sensor
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw hi1336_mipi_raw hi1336_lianyi_mipi_raw gc8034_mipi_raw hi846_dongci_mipi_raw hi846_mipi_raw sp2509v_mipi_raw gc2375h_mipi_raw gc2375h_chengxiangtong_mipi_raw s5k3p9sp_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9772af dw9714af cn3937af
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l6_mipi_raw hi1336_mipi_raw hi1336_lianyi_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9772af dw9714af cn3937af
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc8034_mipi_raw hi846_dongci_mipi_raw hi846_mipi_raw s5k3p9sp_mipi_raw
CUSTOM_KERNEL_SUB_LENS =
# ifeq ($(ODM_WT_EDIT),yes)
# Jianfeng.Liang@ODM_WT.BSP.Sensors.Config, 2018/11/19, Modify for TILTDETECT sensors
...
LCM_FAKE_WIDTH = 0
#ifdef ODM_WT_EDIT
#Benzhong.Hou@ODM_WT.MM.Display.Lcd, 2018/11/30, cts theme host test failed
LCM_HEIGHT = 1520
LCM_WIDTH = 720
#endif
...
#Gong.Chen@ODM_WT.mm.audiodriver.machine, 2018/10/02, Modify for speaker
...
# ifdef ODM_WT_EDIT
#Gong.Chen@ODM_WT.mm.audiodriver.HAL, 2018/11/14, Modify for speaker
...
MTK_BRANCH = alps-mp-o1.mp6.tc16sp
...
MTK_BUILD_VERNO=CPH1909_11_A.36_200303
MTK_BWC_SUPPORT = yes
#ifeq ($(ODM_WT_EDIT),yes)
# xuewen.Sun@ODM_WT.network.modem.lte.1653171, 2018/11/30, Add for "disable c2k"
MTK_C2K_LTE_MODE = 0
#endif
...
ifeq ($(ODM_WT_EDIT),yes)
# fendie.wang@ODM_WT.network.modem.em, 2018/11/29, Add for auto answer
...
#Haibin1.zhang@ODM_WT.BSP.Kernel.Security, 2018/10/23, Modify to disable dm-verity
#ifeq ($(ODM_WT_EDIT),yes)
...
MTK_FMRADIO_APP = yes
#ifdef ODM_WT_EDIT
#guobaopeng@ODM_WT.Connecctivity.FM.config,[BugId:1610512] 2018/12/04, add fm 50KHZ support.
...
# ifdef ODM_WT_EDIT
#Yabin.Huang@ODM_WT.Android.Wtdebug.Logkit.no, 2018/10/10, Modify for mtklog autoboot.
...
#ifdef ODM_WT_EDIT
#Nan.Zhang@ODM_WT.WCN.NFC.Basic, 2018/10/29, Modify for NFC MW8.3
...
#ifdef ODM_WT_EDIT
#Jinfan.Hu@ODM_WT.BSP.Storage.Partition, 2018/09/18, Modify for partition
...
#ifeq ($(ODM_WT_EDIT),yes)
#Feng.Zhao@ODM_WT.BSP.Fingerprint.TEE, 2018/10/03, Modify for TEE
MTK_TEE_SUPPORT = yes
#else
#MTK_TEE_SUPPORT = no
#endif
...
##ifdef VENDOR_EDIT
#Dongtao.Huang@PSW.NW.CFG.1647860, 2018/01/12
#add for disable Telephony Log Debug
...
#Qiujin.Pan@PSW.NW.SIM.1222475, 2018/01/17, Add for COMMON_SLOT enable
...
MTK_MCF_SUPPORT = no
ifeq ($(ODM_WT_EDIT),yes)
#Feng.Zhao@ODM_WT.BSP.Fingerprint.Basic, 2018/10/03, Add for fingerprint support
MTK_FINGERPRINT_SUPPORT = yes
SILEAD_FINGERPRINT_SUPPORT= yes
EGIS_FINGERPRINT_SUPPORT= yes
endif
ifeq ($(ODM_WT_EDIT),yes)
#Honggen.Fan@ODM_WT.Connectivity.BT.config, 2019/01/14, Generate bt_mtk_iot_list.conf
MTK_BT_INTEROP_LIST_TC16 = yes
endif

#ifndef VENDOR_EDIT
#Ming.Liu@PSW.MM.AudioDriver, 2018/11/26,add for FM
OPPO_ENABLE_MTK_FM = yes
#endif

#==============wt_config============
WT_INNER_VERSION=SW_S98607AA1
WT_PRODUCTION_VERSION=oppo6765_18511
